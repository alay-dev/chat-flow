...
export const InputPanel = () => {
  ...
  const onDragStart = (event: DragEvent<HTMLElement>, nodeType: string, type: Entity) => {
  ...
  return (
    <div className="bg-background h-full shadow-xl p-5 relative border-r">
      ...
      <div className="w-full relative">
        <h4 className="text-lg font-bold text-black">Inputs</h4>
        <p className="text-base text-body font-medium">Get inputs from your user</p>
      </div>
